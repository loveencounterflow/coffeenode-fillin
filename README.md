...
- [Implementation Details](#implementation-details)
	- [The RegEx](#the-regex)
- [CND Fillin in the Real World](#cnd-fillin-in-the-real-world)
...
would've worked just as well in this case—this is only a stupid example).
...
The first project where i make use of CND Fillin is [CND Tides](https://github.com/loveencounterflow/coffeenode-tides/),
a fun project to produce visually appealing tides tables with LaTeX and CoffeeScript on NodeJS.
