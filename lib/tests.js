...
(function() {
  ...
  this.test_argument_retrieval = function() {
    ...
    matcher = /.*/;
    probes = [[[data], [data, FILLIN.default_matcher]], [[data, matcher], [data, matcher]]];
    ...
    for (_i = 0, _len = probes.length; _i < _len; _i++) {
      ...
      result = FILLIN._get_data_and_matcher.apply(FILLIN, parameters);
  ...
  this.test_nested_keys = function() {
    ...
    return debug(JSON.stringify(FILLIN.fill_in(template, data)));
  };
